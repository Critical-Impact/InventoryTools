...
namespace InventoryTools.Ui
{
    ...
    public class ItemWindow : UintWindow
    {
        ...
        // private ItemRow? Item => _excelCache.GetItemSheet().GetRow(_itemId);
...
//             }
        ...
        //                     {
        //                         ImGui.OpenPopup("RightClickSource" + itemSource.ItemId);
        //                         var itemRow = _excelCache.GetItemSheet()
        ...
        //                 {
        //                     var craftParts = Item.CompanyCraftSequence.ActiveCompanyCraftParts;
        ...
        //             {
        //                 var item = _excelCache.GetItemSheet().GetRow(craftItem.ItemId);
        //                 if (item != null)
        //                 {
        //                     ImGui.PushID(index);
        ...
        //                     {
        //                         var itemRow = _excelCache.GetItemSheet().GetRow(itemSource.ItemId.Value);
        //                         if (itemRow != null)
        //                         {
        //                             MediatorService.Publish(ImGuiService.RightClickService.DrawRightClickPopup(itemRow));
        //                         }
