...
public class MarketBoardLayout : ConfigLayout
{
    public override PageLayout Build()
    {
        return Page("marketboard", "Market Board",
            Paragraph(
                "Market prices come from Universalis rather than the game, so they are fetched and cached rather than read live."),
            Section("Worlds to price",
                Paragraph(
                    "These combine into a single list, the extra worlds below are added to your home and current world rather than replacing them."),
