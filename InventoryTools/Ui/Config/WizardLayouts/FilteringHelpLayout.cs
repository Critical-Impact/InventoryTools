    ...
    public override PageLayout Build()
    {
        return Page("help/filtering", "Filtering",
            Section("Advanced search syntax",
                Paragraph(
                    "When creating a list, or when searching through the results of a list, you can use a " +
                    "series of operators to make your search more specific. Which operators are available " +
                    "depends on what you are searching against."),
