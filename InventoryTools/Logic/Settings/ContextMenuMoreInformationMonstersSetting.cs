...
namespace InventoryTools.Logic.Settings
{
    ...
    {
        public ContextMenuMoreInformationMonstersSetting(ILogger<ContextMenuMoreInformationMonstersSetting> logger, ImGuiService imGuiService) : base("ContextMenuMoreInfoMonsters" , "Context Menu - More Information (Monsters)", "Add the more information menu item to the right click/context menu for monsters?", true, "14.0.2", logger, imGuiService)
        {
        }
    }
}