    ...
    public class CraftGatherColumn : CheckboxColumn
    {
            ...
            SearchResult searchResult, int rowIndex, int columnIndex)
        {
            ...
            if (CurrentValue(columnConfiguration, searchResult) == true)
            {
                ...
                {
                    hasVendors = DrawVendorButton(searchResult, rowIndex, messages);
                    if (hasVendors)
                    {
                        ImGui.SameLine();
                    }
                    hasGather = DrawGatherButtons(searchResult, rowIndex);
                }
                else
                {
                    hasGather = DrawGatherButtons(searchResult, rowIndex);
        ...
        private bool DrawGatherButtons(SearchResult searchResult, int rowIndex)
        {
        ...
        private bool DrawVendorButton(SearchResult item, int rowIndex, List<MessageBase> messages)
        {
