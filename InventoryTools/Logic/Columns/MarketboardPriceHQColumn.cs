...
namespace InventoryTools.Logic.Columns
{
    public class MarketBoardPriceHQColumn : GilColumn
    {
        ...
        public MarketBoardPriceHQColumn(ILogger<MarketBoardPriceHQColumn> logger, ImGuiService imGuiService, ICharacterMonitor characterMonitor, IMarketCache marketCache) : base(logger, imGuiService)
        {
