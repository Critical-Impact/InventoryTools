...
public abstract class ColumnSetting<T> : IColumnSetting
{
    ...
    public abstract bool Draw(ColumnConfiguration configuration, string? helpText);
    public abstract bool DrawFilter(ColumnConfiguration configuration, string? helpText);
