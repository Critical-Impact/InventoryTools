...
{
    public TestInventoryMonitor(ICharacterMonitor monitor, ICraftMonitor craftMonitor, IInventoryScanner scanner, IFramework frameworkService) : base(monitor, craftMonitor, scanner, frameworkService)
    {
    }
