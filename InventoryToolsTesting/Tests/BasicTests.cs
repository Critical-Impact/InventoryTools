...
namespace InventoryToolsTesting.Tests
{
    ...
    public class BasicTests : BaseTest
    {
        ...
        public void TestSortFilter()
        {
            ...
            //Flour, just cause
            var ryeFlour = excelCache.GetItemExSheet().GetRow(4825)!;
            var wheatFlour = excelCache.GetItemExSheet().GetRow(4826)!;
            var cinnamon = excelCache.GetItemExSheet().GetRow(4828)!;
