    ...
    public class Tests
    {
        ...
        public void TestSearchFilter()
        {
            ...
            if (_character != null && _retainer != null)
            {
                ...
                var emptyList = filterManager.GenerateFilteredList(searchFilter, inventories);
                ...
                var oneList = filterManager.GenerateFilteredList(searchFilter, inventories);
        ...
        public void TestSortFilter()
        {
            ...
            if (_character != null && _retainer != null && _retainer2 != null && ryeFlour != null && wheatFlour != null && cinnamon != null)
            {
                ...
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.All(c => c.InventoryItem.IsEmpty));
                ...
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty) == 1);
                ...
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty) == 2);
                ...
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty) == 0);
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).UnsortableItems.Count(c => !c.IsEmpty) == 0);
                
                //Allow item to spill over to retainer
                searchFilter.DuplicatesOnly = false;
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty && c.DestinationRetainerId == _retainer2.CharacterId) == 1);
                ...
                _characterMonitor?.OverrideActiveRetainer(_retainer.CharacterId);
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty && c.DestinationRetainerId == _retainer2.CharacterId) == 0);
                Assert.True(filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty && c.DestinationRetainerId == _retainer.CharacterId) == 0);
        ...
        public void TestDuplicates()
        {
            ...
            if (_character != null && _retainer != null && _retainer2 != null && ryeFlour != null && wheatFlour != null && cinnamon != null)
            {
                ...
                Assert.AreEqual(3, filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
                
                searchFilter.FilterItemsInRetainers = true;
                
                //1 from bag to retainer, 1 from retainer to other retainer
                var actual = filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Where(c => !c.InventoryItem.IsEmpty).ToList();
        ...
        public void TestCrossCharacterSearching()
        {
            ...
            if (_character != null && _retainer != null && _retainer2 != null && _character2 != null && ryeFlour != null && wheatFlour != null && cinnamon != null)
            {
                ...
                Assert.AreEqual(4, filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
                ...
                Assert.AreEqual(2, filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
                ...
                Assert.AreEqual(0, filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
            }
        }
        ...
        public void TestInventoryCategoryFilters()
        {
            ...
            if (_character != null && _retainer != null && _retainer2 != null && _character2 != null && ryeFlour != null && wheatFlour != null && cinnamon != null)
            {
                ...
                Assert.AreEqual(1, filterManager.GenerateFilteredList(searchFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
                ...
                Assert.AreEqual(1, filterManager.GenerateFilteredList(sortFilter, inventories).SortedItems.Count(c => !c.InventoryItem.IsEmpty));
            }
        }
        ...
        public void TestMarketOrdering()
        {
            if (_retainer != null)
            {
                ...
                retainerMarket2 = retainerMarket2
                    .OrderBy(c =>
                        c.Item == null ? 0 :c.Item.ItemUICategory.Value?.OrderMajor ?? 0)
                    .ThenBy(c =>
                        c.Item == null ? 0 :c.Item.ItemUICategory.Value?.OrderMinor ?? 0)
