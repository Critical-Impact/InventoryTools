...
public class InventoryToolsTestingPlugin : InventoryToolsPlugin
{
    ...
    public InventoryToolsTestingPlugin(IDalamudPluginInterface pluginInterface, IPluginLog pluginLog,
        ...
        IContextMenu contextMenu, ITitleScreenMenu titleScreenMenu, IGameInventory gameInventory, IPlayerState playerState) : base(pluginInterface, pluginLog,
        ...
        titleScreenMenu, gameInventory, playerState)
    {
    }
